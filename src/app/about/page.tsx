  ...
  return (
    <div className='max-w-6xl mx-auto p-3 space-y-4'>
      ...
      <div className="flex space-x-4">
        <a href="https://github.com/Rohitkumar01914" target="_blank" rel="noopener noreferrer">
          <Image src="/link.svg" alt="GitHub" width={24} height={24} />
        </a>
        <a href="https://www.linkedin.com/in/rohitkumar001914/" target="_blank" rel="noopener noreferrer">
          <Image src="/git.svg" alt="LinkedIn" width={24} height={24} />
        </a>
      </div>
